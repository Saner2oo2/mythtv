...
static mmx_t const mmx_1s = {0xffffffffffffffffULL};

static inline void mmx_pack_alpha1s_high(const uint8_t *y1, uint8_t *y2)
{
    movq_m2r (mmx_1s, mm4);
...
static inline void mmx_pack_alpha1s_low(const uint8_t *y1, uint8_t *y2)
{
    movq_m2r (mmx_1s, mm4);
...
static mmx_t const mmx_round  = {0x0002000200020002LL};
